...
export default function MarketplacePage() {
  const force = findForceBySlug("marketplace");
    ...
    <div className="min-h-screen bg-ink text-silver flex flex-col justify-between">
      ...
      <main className="relative pt-24 pb-20 flex-1 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1497493292307-31c376b6e479?auto=format&fit=crop&w=1400&q=80')", backgroundSize: "cover", backgroundPosition: "center" }}
        />
